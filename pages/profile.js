                    ...
                    <div className="p-4 pt-0 md:pt-4 pb-0">
                        <div className="ml-24 md:ml-40 flex justify-between">
                            <div>
                                {editMode && (
                                    <div>
                                        <input className="border py-2 px-3 rounded-md" type={'text'} placeholder={'Your Name'} onChange={ev =>setName(ev.target.value)} value={name}/>
                                    </div>
                                )}
                                {!editMode && (
                                ...
                                {editMode &&(
                                    <div>
                                       <input className="border py-2 px-3 rounded-md mt-1" type={'text'} placeholder={'Your Location'} onChange={ev =>setPlace(ev.target.value)} value={place}/>
                                    </div>
                                )}
                            </div>
                            <div className="grow">
                                ...
                                {isMyUser && !editMode && (
                                    <button onClick={()=>{setEditMode(true);setName(profile.name);setPlace(profile.place)}} className="inline-flex mx-1 gap-1 bg-white rounded-md shadow-sm shadow-gray-500 py-1 px-2">
