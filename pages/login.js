...
export default function LoginPage(){
    ...
    async function loginWithGoogle(){
        await supabases.auth.signInWithOAuth({
            provider: 'google',
                ...
                <h1 className="text-6xl mb-4 text-gray-300 text-center">Login</h1>
                    <Card noPadding={true}>
                        <div className="rounded-md overflow-hidden">
                            ...
                            <Link href="/" clLinkssName="flex gap-4 items-center justify-center p-4 border-b border-b-gray-100 hover:bg-socialBlue hover:text-white hover:border-b-socialBlue  transition-all hover:scale-110">
